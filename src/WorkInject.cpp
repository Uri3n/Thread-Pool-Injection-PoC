...
//
// Note: The worker factory's start routine cannot be overwritten.
...
{
    PFULL_TP_POOL pFullTpPoolBuffer                                     = nullptr;
    size_t bytesRead                                                    = 0;
    LIST_ENTRY* taskQueueHighPriorityList                               = nullptr;
    PFULL_TP_WORK pRemoteFullTpWork                                     = nullptr;
    LIST_ENTRY* pRemoteWorkItemTaskNode                                 = nullptr;
    PFULL_TP_WORK pFullTpWork                                           = nullptr;
    WORKER_FACTORY_BASIC_INFORMATION workerFactoryInfo                  = { 0 };
    fnNtQueryInformationWorkerFactory pNtQueryInformationWorkerFactory  = nullptr;
